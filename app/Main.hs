...
days = [(Day1a.solve, "day1.txt","Day1a",54630),
        ...
        (Day11a.solve, "day11.txt","Day11a",9370588),
        (Day11b.solve, "day11.txt","Day11b",746207878188),
        (Day12a.solve, "day12.txt","Day12a",7460),
        (Day12b.solve, "day12.txt","Day12b",6720660274964),
        (Day13a.solve, "day13.txt","Day13a",34100),
        (Day13b.solve, "day13.txt","Day13b",33106),
        (Day14a.solve, "day14.txt","Day14a",108918),
        (Day14b.solve, "day14.txt","Day14b",100310),
        (Day15a.solve, "day15.txt","Day15a",513158),
        (Day15b.solve, "day15.txt","Day15b",200277),
        (Day16a.solve, "day16.txt","Day16a",7242),
        (Day16b.solve, "day16.txt","Day16b",7572),
        (Day17a.solve, "day17.txt","Day17a",694),
        (Day17b.solve, "day17.txt","Day17b",829),
        (Day18a.solve, "day18.txt","Day18a",26857),
        (Day18b.solve, "day18.txt","Day18b",129373230496292),
        (Day19a.solve, "day19.txt","Day19a",342650),
        (Day19b.solve, "day19.txt","Day19b",130303473508222),
        (Day20a.solve, "day20.txt","Day20a",832957356),
        (Day20b.solve, "day20.txt","Day20b",240162699605221),
        (Day21a.solve, "day21.txt","Day21a",3853),
        (Day21b.solve, "day21.txt","Day21b",639051580070841),
        (Day22a.solve, "day22.txt","Day22a",407),
        (Day22b.solve, "day22.txt","Day22b",59266),
